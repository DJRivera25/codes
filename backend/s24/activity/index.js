...
function getArtistsArray(){
	let favoriteBand = ["Planetshakers", "Hillsong", "Malayang Pilipino", "Victory Worship", "Lakewood"];
	return favoriteBand;
}
...
function getSongsArray() {
	let favoriteSongs = ["london bridge", "twinkle twinkle", "baa baa blacksheep", "Happy Birthday", "boom tarat-tarat"];
...
function getMoviesArray() {
	let favoriteMovies = ["Finding Nemo 1", "Finding Nemo 2", "Spiderman 1", "Spiderman 2", "Spiderman 3"];
