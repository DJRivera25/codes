...
*/
    ...
    console.log("Result of areAllEven function:", isEven);
...
*/
    ...
    console.log("Result of hasDivisibleBy8 function:", hasDivisible);

    return hasDivisible;

}

    console.log(hasDivisibleBy8([8,16,24]));
...
function isPartIncluded(array){
    let isIncluded = array.includes(`RAM`);
    return isIncluded;
}
