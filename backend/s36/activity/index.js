async function embeddedFind(db) {}
async function nestedFind(db) {}
async function findExact(db) {}
async function findRandom(db) {}
async function insertArray(db) {}
 ...
 */
 async function findOneAndUpdateFunc(db) {
    await (
        ...
        // Add only query here. Make sure your query doesn't have a semicolon at the end.
        db.rooms.findOneAndUpdate({name: "family"}, 
